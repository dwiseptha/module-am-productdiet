...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'productdiet/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'productdiet/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'productdiet/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'productdiet/images/file';
